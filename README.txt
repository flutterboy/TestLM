...
####################################################
github: https://github.com/flutterboy/TestLM/tree/release/TestLM-R2
travis ci: https://travis-ci.org/flutterboy/TestLM


The excercise is solved by a unit test.
The execution and the results are visible on travis ci build log
The application provieds also 
	● a webService implementation
	● a rest service implementation
	● a simple and raw html page that allow you to calculate "every receipt you want"

A full build will produce a SpringBootApplication, packaged into a jar file:
run "java -jar item-tax-1.0.0.jar" to start the application.

a web service is available (http://localhost:8080/ws/receipt.wsdl)
a rest service is available at
	● http://localhost:8080/categories (GET)
	● http://localhost:8080/receipt (POST)
a simple web page is available at http://localhost:8080/index.html
